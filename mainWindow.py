...
class MainWindow(wx.Frame):
    ...
    def InitXY(self):
        ...
        wx.StaticText(self, label='Panel Location, ', pos=(5,5))
        wx.StaticText(self, label='x:', pos=(120,5))
        wx.StaticText(self, label='y:', pos=(160,5))
        self.st1 = wx.StaticText(self, label='', pos=(130, 5))
        self.st2 = wx.StaticText(self, label='', pos=(170, 5))
        ...
        MouseXYtext4 = wx.StaticText(self, label='', pos=(130, 25))
        MouseXYtext5 = wx.StaticText(self, label='', pos=(170, 25))
